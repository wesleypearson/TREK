...
const texts: Record<string, DemoTexts> = {
  ...
  en: {
    ...
    description: 'You can view, edit and create events. All changes are automatically reset every hour.',
    ...
    addons: [
      ['Vacay', 'Time-off planner with calendar, public holidays & user fusion'],
      ['Atlas', 'World map with visited countries & tour stats'],
      ['Packing', 'Checklists per event'],
      ['Budget', 'Expense tracking with splitting'],
      ['Documents', 'Attach files to events'],
      ['Widgets', 'Currency converter & timezones'],
    ],
    whatIs: 'What is Travla?',
    whatIsDesc: 'A self-hosted event & tour planner with real-time collaboration, interactive maps, OIDC login and dark mode.',
    close: 'Got it',
  },
  es: {
