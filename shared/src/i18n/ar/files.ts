...
const files: TranslationStrings = {
  ...
  'files.private': 'خاص',
  'files.shareWithGroup': 'مشاركة مع المجموعة',
  'files.makePrivate': 'جعله خاصًا',
  'files.toast.sharedWithGroup': 'تمت المشاركة مع المجموعة',
  'files.toast.madePrivate': 'أصبح خاصًا الآن — يمكنك أنت فقط رؤيته',
  'files.toast.visibilityError': 'تعذر تغيير مستوى الرؤية',
  'files.assign': 'إسناد',
