...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'يتطلب Travla {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"تمت مراجعتها" تعني أن أحد القائمين على Travla فحص هذه الإضافة بحثًا عن البرمجيات الخبيثة في كل إصدار — وليس من حيث الجودة أو ما إذا كانت تعمل. وهي ليست ضمانًا بأن الإضافة غير ضارة.',
  ...
  'admin.plugins.security.reviewedBody':
    'الإضافة التي تمت مراجعتها فُحصت يدويًا بحثًا عن البرمجيات الخبيثة بواسطة أحد القائمين على Travla في كل إصدار — جرى فحصها بحثًا عن شيفرة ضارة، لا لمعرفة ما إذا كانت تعمل جيدًا. وهي ليست وعدًا بأن الإضافة غير ضارة.',
  'admin.plugins.security.trustTitle': 'الخلاصة',
  'admin.plugins.security.trustBody':
    'تثبيت إضافة يشبه تثبيت أي تطبيق من جهة خارجية: لا تُضِف سوى شيفرة من مطورين تثق بهم، وعند الشك، افحصها بنفسك أولًا. لا يتحمل Travla أي مسؤولية عن إضافات الجهات الخارجية.',
  ...
  'admin.weather.description':
    'يستخدم Travla خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
