...
const files: TranslationStrings = {
  ...
  'files.unstar': '取消收藏',
  'files.private': '私密',
  'files.shareWithGroup': '與群組共享',
  'files.makePrivate': '設為私密',
  'files.toast.sharedWithGroup': '已與群組共享',
  'files.toast.madePrivate': '已設為私密，僅你可見',
  'files.toast.visibilityError': '無法變更可見性',
  'files.assign': '分配',
