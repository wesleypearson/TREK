...
const files: TranslationStrings = {
  ...
  'files.shareWithGroup': 'Compartir con el grupo',
  'files.makePrivate': 'Hacer privado',
  'files.toast.sharedWithGroup': 'Compartido con el grupo',
  'files.toast.madePrivate': 'Ahora es privado — solo tú puedes verlo',
  'files.toast.visibilityError': 'No se pudo cambiar la visibilidad',
