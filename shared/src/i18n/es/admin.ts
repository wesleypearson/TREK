...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Requiere Travla {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Revisado" significa que un responsable de Travla analizó este plugin en busca de malware en cada versión, no su calidad ni si funciona. No es una garantía de que un plugin sea inofensivo.',
  ...
  'admin.plugins.security.reviewedBody':
    'Un plugin revisado fue analizado manualmente en busca de malware por un responsable de Travla en cada versión — se comprobó que no tuviera código malicioso, no si funciona bien. No es una promesa de que el plugin sea inofensivo.',
  'admin.plugins.security.trustTitle': 'En resumen',
  'admin.plugins.security.trustBody':
    'Instalar un plugin es como instalar cualquier aplicación de terceros: añade únicamente código de autores en los que confíes y, en caso de duda, inspecciónalo tú mismo primero. Travla no asume ninguna responsabilidad por los plugins de terceros.',
  ...
  'admin.tabs.github': 'Actualizaciones',
  ...
  'admin.github.subtitle': 'Últimas novedades',
  ...
  'admin.update.button': 'Ver notas de la versión',
