...
const files: TranslationStrings = {
  ...
  'files.unstar': '取消收藏',
  'files.private': '私密',
  'files.shareWithGroup': '与群组共享',
  'files.makePrivate': '设为私密',
  'files.toast.sharedWithGroup': '已与群组共享',
  'files.toast.madePrivate': '已设为私密，仅你可见',
  'files.toast.visibilityError': '无法更改可见性',
  'files.assign': '分配',
