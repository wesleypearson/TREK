...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Требуется Travla {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '«Проверен» означает, что сопровождающий Travla проверял этот плагин на вредоносный код в каждой версии — но не его качество или работоспособность. Это не гарантия того, что плагин безвреден.',
  ...
  'admin.plugins.security.reviewedBody':
    'Проверенный плагин был вручную просканирован на вредоносный код сопровождающим Travla в каждой версии — проверен на вредоносный код, а не на то, насколько хорошо он работает. Это не обещание того, что плагин безвреден.',
  'admin.plugins.security.trustTitle': 'Итог',
  'admin.plugins.security.trustBody':
    'Установка плагина похожа на установку любого стороннего приложения: добавляйте только код от авторов, которым доверяете, а при сомнениях сначала проверьте его самостоятельно. Travla не несёт ответственности за сторонние плагины.',
  ...
  'admin.github.subtitle': 'Последние обновления',
  ...
  'admin.update.button': 'Посмотреть примечания к выпуску',
