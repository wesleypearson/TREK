...
const files: TranslationStrings = {
  ...
  'files.private': 'Личное',
  'files.shareWithGroup': 'Поделиться с группой',
  'files.makePrivate': 'Сделать личным',
  'files.toast.sharedWithGroup': 'Доступно группе',
  'files.toast.madePrivate': 'Теперь это личное — видно только вам',
  'files.toast.visibilityError': 'Не удалось изменить видимость',
