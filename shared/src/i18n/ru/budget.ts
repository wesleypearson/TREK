...
const budget: TranslationStrings = {
  ...
  'costs.tabsHint': 'Поделитесь ссылкой, по которой человек увидит, сколько именно он вам должен — без регистрации. Новые расходы добавляются к тому же счёту, пока он не расплатится.',
  ...
  'costs.tabLinkHint': 'Привязанные счета следуют за расчётами поездки: чтобы разделить трату, назначьте этого человека в разделении расхода.',
  'costs.tabLinked': 'Привязан',
  'costs.tabLiveHint': 'Следует за расчётами поездки — делите траты с {name}, назначая этого человека в разделении расхода.',
