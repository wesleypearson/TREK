...
const files: TranslationStrings = {
  ...
  'files.private': 'Privé',
  'files.shareWithGroup': 'Delen met groep',
  'files.makePrivate': 'Privé maken',
  'files.toast.sharedWithGroup': 'Gedeeld met de groep',
  'files.toast.madePrivate': 'Nu privé — alleen jij kunt het zien',
  'files.toast.visibilityError': 'Kon zichtbaarheid niet wijzigen',
