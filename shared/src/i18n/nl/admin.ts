...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Vereist Travla {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Beoordeeld" betekent dat een Travla-beheerder deze plugin bij elke versie op malware heeft gecontroleerd — niet op kwaliteit of op de vraag of hij werkt. Het is geen garantie dat een plugin ongevaarlijk is.',
  ...
  'admin.plugins.security.reviewedBody':
    'Een beoordeelde plugin is bij elke versie handmatig door een Travla-beheerder op malware gecontroleerd — gecontroleerd op kwaadaardige code, niet op de vraag of hij goed werkt. Het is geen belofte dat de plugin ongevaarlijk is.',
  'admin.plugins.security.trustTitle': 'De conclusie',
  'admin.plugins.security.trustBody':
    'Een plugin installeren is als het installeren van elke andere app van derden: voeg alleen code toe van auteurs die je vertrouwt en controleer deze bij twijfel eerst zelf. Travla aanvaardt geen enkele verantwoordelijkheid voor plugins van derden.',
  ...
  'admin.weather.description':
    'Travla gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.github.subtitle': 'Laatste updates',
  ...
  'admin.update.button': 'Release notes bekijken',
  ...
  'admin.update.dockerText':
    "Je Travla-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando's uit op je server:",
  'admin.update.nonDockerText':
    'Deze Travla-instantie draait niet in Docker. Om bij te werken naar {version}, voer de installatie- of updatemethode die je hebt gebruikt opnieuw uit — bij Proxmox Community Scripts voer je de update bijvoorbeeld uit vanuit de LXC-console:',
