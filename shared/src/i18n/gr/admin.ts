...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Απαιτεί Travla {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    'Το "Ελεγμένο" σημαίνει ότι ένας συντηρητής του Travla σάρωσε αυτό το plugin για κακόβουλο λογισμικό σε κάθε έκδοση — όχι για την ποιότητα ή για το αν λειτουργεί. Δεν αποτελεί εγγύηση ότι ένα plugin είναι ακίνδυνο.',
  ...
  'admin.plugins.security.reviewedBody':
    'Ένα ελεγμένο plugin σαρώθηκε χειροκίνητα για κακόβουλο λογισμικό από έναν συντηρητή του Travla σε κάθε έκδοση — ελέγχθηκε για εχθρικό κώδικα, όχι για το αν λειτουργεί καλά. Δεν αποτελεί υπόσχεση ότι το plugin είναι ακίνδυνο.',
  'admin.plugins.security.trustTitle': 'Το συμπέρασμα',
  'admin.plugins.security.trustBody':
    'Η εγκατάσταση ενός plugin είναι σαν την εγκατάσταση οποιασδήποτε εφαρμογής τρίτου: προσθέστε κώδικα μόνο από δημιουργούς που εμπιστεύεστε, και σε περίπτωση αμφιβολίας, ελέγξτε τον πρώτα μόνοι σας. Το Travla δεν αναλαμβάνει καμία ευθύνη για plugins τρίτων.',
  ...
  'admin.github.subtitle': 'Τελευταίες ενημερώσεις',
  ...
  'admin.update.button': 'Προβολή σημειώσεων έκδοσης',
