...
const budget: TranslationStrings = {
  ...
  'costs.tabLinkHint': 'Οι συνδεδεμένοι λογαριασμοί ακολουθούν τα κοινά έξοδα του ταξιδιού: μοιραστείτε μια δαπάνη ορίζοντας αυτό το άτομο στην κατανομή του εξόδου.',
  'costs.tabLinked': 'Συνδεδεμένος',
  'costs.tabLiveHint': 'Ακολουθεί τα κοινά έξοδα του ταξιδιού — μοιραστείτε δαπάνες με τον/την {name} ορίζοντας το άτομο στην κατανομή του εξόδου.',
