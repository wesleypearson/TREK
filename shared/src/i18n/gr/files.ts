...
const files: TranslationStrings = {
  ...
  'files.private': 'Ιδιωτικό',
  'files.shareWithGroup': 'Κοινοποίηση στην ομάδα',
  'files.makePrivate': 'Ορισμός ως ιδιωτικό',
  'files.toast.sharedWithGroup': 'Κοινοποιήθηκε στην ομάδα',
  'files.toast.madePrivate': 'Πλέον ιδιωτικό — μόνο εσείς μπορείτε να το δείτε',
  'files.toast.visibilityError': 'Δεν ήταν δυνατή η αλλαγή της ορατότητας',
