...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Μοιραστείτε το πλάνο διακοπών σας με άλλους χρήστες Travla',
  'vacay.owner': 'Κάτοχος',
  'vacay.shareEmailPlaceholder': 'Email χρήστη Travla',
  ...
  'vacay.inviteHint': 'Προσκαλέστε έναν άλλο χρήστη Travla για να μοιραστείτε ένα κοινό ημερολόγιο διακοπών.',
