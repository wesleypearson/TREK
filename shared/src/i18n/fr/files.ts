...
const files: TranslationStrings = {
  ...
  'files.private': 'Privé',
  'files.shareWithGroup': 'Partager avec le groupe',
  'files.makePrivate': 'Rendre privé',
  'files.toast.sharedWithGroup': 'Partagé avec le groupe',
  'files.toast.madePrivate': 'Désormais privé — vous seul pouvez le voir',
  'files.toast.visibilityError': 'Impossible de modifier la visibilité',
