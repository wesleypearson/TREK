...
const oauth: TranslationStrings = {
  'oauth.scope.group.trips': 'Events',
  'oauth.scope.group.places': 'Venues',
  ...
  'oauth.scope.group.journey': 'Tour',
  'oauth.scope.trips:read.label': 'View events & schedules',
  'oauth.scope.trips:read.description': 'Read events, days, day notes, and crew',
  'oauth.scope.trips:write.label': 'Edit events & schedules',
  'oauth.scope.trips:write.description': 'Create and update events, days, notes, and manage crew',
  'oauth.scope.trips:delete.label': 'Delete events',
  'oauth.scope.trips:delete.description': 'Permanently delete entire events — this action is irreversible',
  'oauth.scope.trips:share.label': 'Manage share links',
  'oauth.scope.trips:share.description': 'Create, update, and revoke public share links for events',
  'oauth.scope.places:read.label': 'View venues & map data',
  'oauth.scope.places:read.description': 'Read venues, day assignments, tags, and categories',
  'oauth.scope.places:write.label': 'Manage venues',
  'oauth.scope.places:write.description': 'Create, update, and delete venues, assignments, and tags',
  ...
  'oauth.scope.todos:read.description': 'Read event to-do items and category assignees',
  ...
  'oauth.scope.weather:read.description': 'Fetch weather forecasts for event locations and dates',
  'oauth.scope.journey:read.label': 'View tours',
  'oauth.scope.journey:read.description': 'Read tours, entries, and contributor list',
  'oauth.scope.journey:write.label': 'Manage tours',
  'oauth.scope.journey:write.description': 'Create, update, and delete tours and their entries',
  'oauth.scope.journey:share.label': 'Manage tour links',
  'oauth.scope.journey:share.description': 'Create, update, and revoke public share links for tours',
  ...
  'oauth.authorize.alwaysTool.listTrips': 'List your events so the AI can discover event IDs',
  'oauth.authorize.alwaysTool.getTripSummary': 'Read an event overview needed to use any other tool',
};
