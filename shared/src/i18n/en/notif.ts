...
const notif: TranslationStrings = {
  ...
  'notif.trip_invite.title': 'Event Invitation',
  ...
  'notif.schedule_change.title': 'Timings Changed',
  'notif.schedule_change.text': '{count} timing update(s) in {trip}',
  'notif.trip_reminder.title': 'Event Reminder',
  'notif.trip_reminder.text': 'Your event {trip} is coming up soon!',
  'notif.todo_due.title': 'To-do due',
  'notif.todo_due.text': '{todo} in {trip} is due on {due}',
  'notif.vacay_invite.title': 'Vacay Fusion Invite',
  'notif.vacay_invite.text': '{actor} invited you to fuse production plans',
  ...
  'notif.action.view_trip': 'View Event',
