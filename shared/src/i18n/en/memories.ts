...
const memories: TranslationStrings = {
  ...
  'memories.notConnectedHint': 'Connect your {provider_name} instance in Settings to be able add photos to this event.',
  'memories.notConnectedMultipleHint':
    'Connect any of these photo providers: {provider_names} in Settings to be able add photos to this event.',
  'memories.noDates': 'Add dates to your event to load photos.',
  'memories.noPhotos': 'No photos found',
  'memories.noPhotosHint': "No photos found in {provider_name} for this event's date range.",
  ...
  'memories.immichAutoUpload': 'Mirror tour photos to Immich on upload',
  ...
  'memories.tripDates': 'Event dates',
  'memories.allPhotos': 'All photos',
  'memories.confirmShareTitle': 'Share with event crew?',
  'memories.confirmShareHint':
    '{count} photos will be visible to all crew members of this event. You can make individual photos private later.',
