...
const files: TranslationStrings = {
  ...
  'files.emptyHint': 'Upload files to attach them to your event',
  ...
  'files.shareWithGroup': 'Share with group',
  'files.makePrivate': 'Make private',
  'files.toast.sharedWithGroup': 'Shared with the group',
  'files.toast.madePrivate': 'Now private — only you can see it',
  'files.toast.visibilityError': 'Could not change visibility',
  'files.assign': 'Assign',
  'files.assignTitle': 'Assign File',
  'files.assignPlace': 'Venue',
