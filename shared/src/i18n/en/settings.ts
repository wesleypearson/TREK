...
const settings: TranslationStrings = {
  ...
  'settings.mapProviderHint': 'Affects Event Planner and Tour maps. Atlas always uses Leaflet.',
  ...
  'settings.mapTip':
    'right-click and drag to rotate/pitch the map. Middle-click to add a venue (right-click is reserved for rotation).',
  'settings.latitude': 'Latitude',
  'settings.longitude': 'Longitude',
  'settings.saveMap': 'Save Map',
  'settings.apiKeys': 'API Keys',
  'settings.mapsKey': 'Google Maps API Key',
  'settings.mapsKeyHint': 'For venue search. Requires Places API (New). Get at console.cloud.google.com',
  ...
  'settings.mapPoiPill': 'Explore venues on the map',
  'settings.mapPoiPillHint':
    'Show a category pill on the event map to find nearby restaurants, hotels and more from OpenStreetMap.',
  ...
  'settings.notifyTripInvite': 'Event invitations',
  'settings.notifyBookingChange': 'Booking changes',
  'settings.notifyTripReminder': 'Event reminders',
  ...
  'settings.oauth.modal.scopesHint':
    'list_trips and get_trip_summary are always available — no scope required. They let the AI discover event IDs needed to use any other tool.',
  ...
  'settings.about.description':
    'Travla is a self-hosted production planner that helps you organize your events from the first idea to the final show. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.',
  ...
  'settings.deleteAccountWarning':
    'Your account and all your events, venues, and files will be permanently deleted. This action cannot be undone.',
  ...
  'settings.appearance.widget.tripsTotal': 'Events total',
  'settings.appearance.widget.daysTraveled': 'Days on tour',
  ...
  'settings.offline.prepare.hint':
    'Download everything you need — event data, documents and map tiles — before you lose connection.',
  ...
  'settings.offline.prepare.phase.trips': 'Event data',
  ...
  'settings.offline.storage.tilesHint':
    'Map tiles use the most storage. Turn this off to keep only event data and documents offline.',
  'settings.offline.storage.tripsTitle': 'Events',
  ...
  'settings.offline.clearConfirm': 'Clear all offline event data? You can re-sync anytime while online.',
  'settings.offline.stats.trips': 'Cached events',
  ...
  'settings.offline.empty': 'No events cached yet. Connect to the internet to sync.',
  ...
  'settings.paymentDetailsHint':
    'Shown on the public expense tabs you share, so people know how to pay you back. All fields are optional and only visible to someone with one of your tab links.',
  ...
  'settings.analytics': 'Share anonymous usage analytics',
  'settings.analyticsHint':
    'Helps the crew improve Travla by sharing anonymous usage patterns with our own self-hosted analytics. Nothing is shared with third parties.',
};
