...
const register: TranslationStrings = {
  ...
  'register.subtitle': 'Create an account and start planning your next events.',
  'register.feature1': 'Unlimited event plans',
  'register.feature2': 'Interactive map view',
  'register.feature3': 'Manage venues and categories',
  ...
  'register.startPlanning': 'Start your event planning',
