...
const reservations: TranslationStrings = {
  ...
  'reservations.placeHint': 'Tip: Reservations are best created directly from a venue to link them with your day plan.',
  ...
  'reservations.meta.linkPlace': 'Venue / Activity',
  'reservations.meta.pickPlace': 'Select venue / activity',
  ...
  'reservations.place': 'Venue',
  'reservations.noPlace': 'No Venue',
  ...
  'reservations.airtrail.skippedDuplicate': '{count} already in this event, skipped',
  ...
  'reservations.airtrail.duringTrip': 'During this event',
