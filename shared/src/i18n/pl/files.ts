...
const files: TranslationStrings = {
  ...
  'files.private': 'Prywatny',
  'files.shareWithGroup': 'Udostępnij grupie',
  'files.makePrivate': 'Ustaw jako prywatny',
  'files.toast.sharedWithGroup': 'Udostępniono grupie',
  'files.toast.madePrivate': 'Teraz prywatny — tylko Ty go widzisz',
  'files.toast.visibilityError': 'Nie udało się zmienić widoczności',
