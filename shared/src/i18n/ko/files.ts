...
const files: TranslationStrings = {
  ...
  'files.private': '비공개',
  'files.shareWithGroup': '그룹과 공유',
  'files.makePrivate': '비공개로 전환',
  'files.toast.sharedWithGroup': '그룹과 공유했습니다',
  'files.toast.madePrivate': '이제 비공개입니다. 나만 볼 수 있습니다',
  'files.toast.visibilityError': '공개 설정을 변경할 수 없습니다',
  'files.assign': '배정',
