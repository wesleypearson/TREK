...
const admin: TranslationStrings = {
  ...
  'admin.weather.description':
    'Travla은 날씨 데이터 소스로 Open-Meteo를 사용합니다. Open-Meteo는 무료 오픈 소스 날씨 서비스로 API 키가 필요 없습니다.',
  ...
  'admin.update.confirmText': 'Travla이 {current}에서 {version}으로 업데이트됩니다. 서버가 이후 자동으로 재시작됩니다.',
