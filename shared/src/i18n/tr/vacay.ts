...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Tatil planınızı diğer Travla kullanıcılarıyla paylaşın',
  'vacay.owner': 'Mal sahibi',
  'vacay.shareEmailPlaceholder': 'Travla kullanıcısının e-postası',
  ...
  'vacay.inviteHint': 'Başka bir Travla kullanıcısını birleşik bir tatil takvimini paylaşmaya davet edin.',
