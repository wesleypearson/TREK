...
const files: TranslationStrings = {
  ...
  'files.private': 'Özel',
  'files.shareWithGroup': 'Grupla paylaş',
  'files.makePrivate': 'Özel yap',
  'files.toast.sharedWithGroup': 'Grupla paylaşıldı',
  'files.toast.madePrivate': 'Artık özel — sadece siz görebilirsiniz',
  'files.toast.visibilityError': 'Görünürlük değiştirilemedi',
  'files.assign': 'Ata',
