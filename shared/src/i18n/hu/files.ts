...
const files: TranslationStrings = {
  ...
  'files.private': 'Privát',
  'files.shareWithGroup': 'Megosztás a csoporttal',
  'files.makePrivate': 'Priváttá tétel',
  'files.toast.sharedWithGroup': 'Megosztva a csoporttal',
  'files.toast.madePrivate': 'Mostantól privát — csak te láthatod',
  'files.toast.visibilityError': 'Nem sikerült módosítani a láthatóságot',
