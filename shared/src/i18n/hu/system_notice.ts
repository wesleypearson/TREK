...
const system_notice: TranslationStrings = {
  ...
  'system_notice.thank_you_support.title': 'Köszönöm, hogy a Travlát használod',
  'system_notice.thank_you_support.body':
    'Gyors köszönet, hogy telepítetted a Travlát — őszintén sokat jelent.\n\nEgyedül fejlesztek, és a szabadidőmben építem a Travlát. Egy kis eszközként indult, csak a saját utazásaimhoz, és azóta őszintén lenyűgöz a közösség támogatása és érdeklődése. A Travla sok szívvel készül a részemről — de annak a sok csodálatos külső közreműködőnek is köszönhetően, akik segítettek formálni.\n\n**A Travla nyílt forráskódú és teljesen ingyenes — és ez örökre így is marad. Nincsenek fizetős csomagok, nincsenek előfizetések, nincs semmi átverés. Ígérem.**\n\nHa a Travla hasznos számodra, és szeretnéd támogatni a fejlesztését, egy kis kávé őszintén segít, hogy tovább építhessem — semmi nyomás, de minden csésze átsegít a késő éjszakákon.\n\nKöszönöm, hogy itt vagy.\n\n— Maurice',
