...
const files: TranslationStrings = {
  ...
  'files.private': 'Pribadi',
  'files.shareWithGroup': 'Bagikan ke grup',
  'files.makePrivate': 'Jadikan pribadi',
  'files.toast.sharedWithGroup': 'Dibagikan ke grup',
  'files.toast.madePrivate': 'Sekarang pribadi — hanya kamu yang bisa melihatnya',
  'files.toast.visibilityError': 'Tidak dapat mengubah visibilitas',
