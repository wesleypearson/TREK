...
const files: TranslationStrings = {
  ...
  'files.private': 'Privato',
  'files.shareWithGroup': 'Condividi con il gruppo',
  'files.makePrivate': 'Rendi privato',
  'files.toast.sharedWithGroup': 'Condiviso con il gruppo',
  'files.toast.madePrivate': 'Ora è privato — solo tu puoi vederlo',
  'files.toast.visibilityError': 'Impossibile modificare la visibilità',
