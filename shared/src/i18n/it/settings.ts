...
const settings: TranslationStrings = {
  ...
  'settings.about.description':
    "Travla è un pianificatore di viaggi self-hosted che ti aiuta a organizzare i tuoi viaggi dalla prima idea all'ultimo ricordo. Pianificazione giornaliera, budget, liste bagagli, foto e molto altro — tutto in un unico posto, sul tuo server.",
  ...
  'settings.airtrail.writeBackHint':
    'Disattivato per impostazione predefinita: AirTrail è la fonte attendibile e Travla si limita a leggerlo. Attiva per inviare ad AirTrail le modifiche fatte in Travla.',
  ...
  'settings.paymentDetailsHint':
    'Mostrati sui conti pubblici che condividi, così chi ti deve dei soldi sa come ripagarti. Tutti i campi sono facoltativi e visibili solo a chi ha uno dei tuoi link.',
  ...
  'settings.analyticsHint':
    'Aiuta il gruppo a migliorare Travla condividendo schemi d’uso anonimi con il nostro sistema di statistiche self-hosted. Nulla viene condiviso con terze parti.',
};
