...
const files: TranslationStrings = {
  ...
  'files.shareWithGroup': 'Mit Gruppe teilen',
  'files.makePrivate': 'Privat machen',
  'files.toast.sharedWithGroup': 'Mit der Gruppe geteilt',
  'files.toast.madePrivate': 'Jetzt privat — nur du kannst es sehen',
  'files.toast.visibilityError': 'Sichtbarkeit konnte nicht geändert werden',
