...
const settings: TranslationStrings = {
  ...
  'settings.paymentDetailsHint':
    'Wird auf den öffentlichen Deckeln angezeigt, die du teilst — so wissen andere, wie sie dir Geld zurückzahlen können. Alle Felder sind optional und nur für Personen mit einem deiner Deckel-Links sichtbar.',
  ...
  'settings.analytics': 'Anonyme Nutzungsanalysen teilen',
  'settings.analyticsHint':
    'Hilft der Crew, Travla zu verbessern, indem anonyme Nutzungsmuster mit unserer eigenen, selbst gehosteten Analytics geteilt werden. Nichts wird an Dritte weitergegeben.',
};
