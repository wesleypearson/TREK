...
const files: TranslationStrings = {
  ...
  'files.private': 'Soukromé',
  'files.shareWithGroup': 'Sdílet se skupinou',
  'files.makePrivate': 'Nastavit jako soukromé',
  'files.toast.sharedWithGroup': 'Sdíleno se skupinou',
  'files.toast.madePrivate': 'Nyní soukromé — vidíte ho jen vy',
  'files.toast.visibilityError': 'Viditelnost se nepodařilo změnit',
