...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Vyžaduje Travla {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '„Zkontrolováno“ znamená, že správce Travla prověřil tento plugin na škodlivý kód u každé verze — nikoli jeho kvalitu ani to, zda funguje. Není to záruka, že je plugin neškodný.',
  ...
  'admin.plugins.security.isolationBody':
    'Plugin běží jako vlastní uzamčený proces, který může číst pouze své vlastní soubory. Nemůže číst vaši databázi, váš přihlašovací tajný klíč ani váš šifrovací klíč, nemůže spouštět jiné programy a nemůže nikam zapisovat soubory. Jeho rozhraní běží v uzavřeném rámci prohlížeče, který nemůže číst vaši session cookie ani zasahovat do okolní stránky Travla.',
  'admin.plugins.security.permsTitle': 'Co oprávnění znamenají',
  'admin.plugins.security.permsBody':
    'Oprávnění zobrazená před instalací jsou pevný limit, který Travla vynucuje po celou dobu běhu pluginu — plugin doslova nemůže udělat nic, co není na seznamu. Říkají vám ale, co plugin může dělat, nikoli co skutečně dělá. Plugin, který smí číst vaše cesty a spojit se se serverem, může vaše cesty tomuto serveru odeslat, proto si přečtěte oprávnění i odchozí hostitele, nejen popis.',
  'admin.plugins.security.limitsTitle': 'Co nemůžeme slíbit',
  'admin.plugins.security.limitsBody':
    'Izolace je silná softwarová hranice, nikoli absolutní. Plugin jedná přesně s těmi právy, která schválíte, takže v jejich rámci se může chovat jinak, než naznačuje jeho popis, a může odeslat data, která oprávněně drží, hostitelům, které deklaroval. Travla nečte ani neposuzuje, co kód pluginu ve skutečnosti dělá.',
  ...
  'admin.plugins.security.reviewedBody':
    'Zkontrolovaný plugin ručně prověřil správce Travla na škodlivý kód u každé verze — kontroloval nepřátelský kód, nikoli to, zda dobře funguje. Není to slib, že je plugin neškodný.',
  'admin.plugins.security.trustTitle': 'Závěrem',
  'admin.plugins.security.trustBody':
    'Instalace pluginu je jako instalace jakékoli aplikace třetí strany: přidávejte pouze kód od autorů, kterým důvěřujete, a v případě pochybností si jej nejprve sami prohlédněte. Travla nenese žádnou odpovědnost za pluginy třetích stran.',
