...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Потрібен Travla {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '«Перевірено» означає, що супроводжувач Travla перевіряв цей плагін на наявність шкідливого коду в кожній версії — а не на якість чи працездатність. Це не гарантія того, що плагін безпечний.',
  ...
  'admin.plugins.security.reviewedBody':
    'Перевірений плагін вручну сканував супроводжувач Travla на наявність шкідливого коду в кожній версії — перевіряли на ворожий код, а не на те, чи добре він працює. Це не обіцянка, що плагін безпечний.',
  'admin.plugins.security.trustTitle': 'Підсумок',
  'admin.plugins.security.trustBody':
    'Встановлення плагіна — це те саме, що встановлення будь-якого стороннього застосунку: додавайте лише код від авторів, яким довіряєте, а в разі сумнівів спершу перевірте його самостійно. Travla не несе відповідальності за сторонні плагіни.',
  ...
  'admin.addons.subtitle': 'Увімкніть або вимкніть функції, щоб налаштувати Travla під себе.',
  ...
  'admin.weather.description':
    'Travla використовує Open-Meteo як джерело даних про погоду. Open-Meteo — безкоштовний сервіс з відкритим кодом, API-ключ не потрібен.',
  ...
  'admin.github.subtitle': 'Останні оновлення',
  ...
  'admin.update.text': 'Доступна версія Travla {version}. У вас встановлено {current}.',
  'admin.update.button': 'Переглянути нотатки до випуску',
  'admin.update.install': 'Встановити оновлення',
  'admin.update.confirmTitle': 'Встановити оновлення?',
  'admin.update.confirmText': 'Travla буде оновлено з {current} до {version}. Сервер перезапуститься автоматично.',
  ...
  'admin.update.dockerText':
    'Ваш екземпляр Travla працює в Docker. Для оновлення до {version} виконайте ці команди на сервері:',
  'admin.update.nonDockerText':
    'Цей екземпляр Travla не працює в Docker. Щоб оновити до {version}, повторно запустіть метод встановлення або оновлення, який ви використовували, — наприклад, у Proxmox Community Scripts запустіть оновлення з консолі LXC:',
