...
const files: TranslationStrings = {
  ...
  'files.private': 'Privado',
  'files.shareWithGroup': 'Compartilhar com o grupo',
  'files.makePrivate': 'Tornar privado',
  'files.toast.sharedWithGroup': 'Compartilhado com o grupo',
  'files.toast.madePrivate': 'Agora é privado — só você pode ver',
  'files.toast.visibilityError': 'Não foi possível alterar a visibilidade',
