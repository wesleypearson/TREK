...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Requer Travla {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Revisado" significa que um mantenedor do Travla verificou este plugin em busca de malware em cada versão — não quanto à qualidade ou se ele funciona. Não é garantia de que um plugin seja inofensivo.',
  ...
  'admin.plugins.security.reviewedBody':
    'Um plugin revisado foi verificado manualmente em busca de malware por um mantenedor do Travla em cada versão — checado quanto a código malicioso, não quanto a funcionar bem. Não é uma promessa de que o plugin seja inofensivo.',
  'admin.plugins.security.trustTitle': 'Em resumo',
  'admin.plugins.security.trustBody':
    'Instalar um plugin é como instalar qualquer app de terceiros: adicione apenas código de autores em quem você confia e, em caso de dúvida, inspecione-o você mesmo antes. O Travla não assume nenhuma responsabilidade por plugins de terceiros.',
  ...
  'admin.tabs.github': 'Atualizações',
  'admin.github.title': 'Histórico de versões',
  'admin.github.subtitle': 'Últimas atualizações',
  ...
  'admin.update.button': 'Ver notas da versão',
