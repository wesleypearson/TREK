...
const files: TranslationStrings = {
  ...
  'files.star': 'スター',
  'files.unstar': 'スター解除',
  'files.private': 'プライベート',
  'files.shareWithGroup': 'グループと共有',
  'files.makePrivate': 'プライベートにする',
  'files.toast.sharedWithGroup': 'グループと共有しました',
  'files.toast.madePrivate': 'プライベートになりました。表示できるのは自分だけです',
  'files.toast.visibilityError': '公開設定を変更できませんでした',
  'files.assign': '割り当て',
